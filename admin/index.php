            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-2 pt-md-3 mt-lg-3 sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="index.php" class="nav-link fs-6 active" aria-current="page" href="#">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="bg-success card w-100 text-white bg-opacity-75">
                            <div class=" card-body">
                                <h1 class="card-title">5</h5>
                                    <p class="card-text fs-5">Jumlah Produk</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="bg-warning card w-100 text-white bg-opacity-75">
                            <div class=" card-body">
                                <h1 class="card-title">100</h5>
                                    <p class="card-text fs-5">Jumlah Transaksi</p>
                            </div>
                        </div>
                    </div>
