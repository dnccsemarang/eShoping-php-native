                    ...
                    <?php foreach ($products as $key => $product) : ?>
                        <div class="col-md-3">
                            <div class="card shadow-sm">
                                <img class="img-fluid card-img" width="50" src="<?= $product['image'] ?>" alt="">

                                <div class="card-body">
                                    <h3><?= $product['name'] ?></h3>
                                    <h5>Rp. <?= number_format($product['price'])?></h5>
                                    <p class="card-text text-truncate" data-bs-toggle="tooltip" data-bs-original-title="<?=$product['description']?>">
                                        <?= $product['description']?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="detail.php?id=<?= $product['id_produk']?>" class="btn bg-info fs-6 bg-opacity-50 ">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
